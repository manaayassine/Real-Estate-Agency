...
@Component({
  selector: 'app-business1news',
  templateUrl: './business1news.component.html',
  styleUrls: ['./business1news.component.css']
})
export class Business1newsComponent implements OnInit {
  searchText!:any;
