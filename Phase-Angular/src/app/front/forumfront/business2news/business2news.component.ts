...
@Component({
  selector: 'app-business2news',
  templateUrl: './business2news.component.html',
  styleUrls: ['./business2news.component.css']
})
export class Business2newsComponent implements OnInit {
  searchText!:any;
